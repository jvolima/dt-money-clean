...
describe('AxiosHttpClient', () => {
  describe('post', () => {
    ...
    it('Should be able to return the correct response on axios.post', async () => {
      const { sut, mockedAxios } = makeSut()
    ...
    it('Should be able to return the correct response in failure on axios.post', async () => {
      const { sut, mockedAxios } = makeSut()
  ...
  describe('get', () => {
    ...
    it('Should be able to return the correct response on axios.get', async () => {
      const { sut, mockedAxios } = makeSut()
    ...
    it('Should be able to return the correct response in failure on axios.get', async () => {
      const { sut, mockedAxios } = makeSut()
